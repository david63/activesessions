...
{
	const ACTIVE_SESSIONS_VERSION = '2.1.1';
	...
	public function is_enableable()
 	{
		...
		if (!$is_enableable)
		{
			...
			{
				$this->container->get('language')->add_lang('ext_enable_error', 'david63/activesessions');
			}
			else
			{
				$this->container->get('user')->add_lang_ext('david63/activesessions', 'ext_enable_error');
			}
		}
